...
select jsonb_build_object(
  ...
  'lastRun',(select jsonb_build_object('status',run_status,'sourcesAttempted',sources_attempted,'sourcesSucceeded',listings_found,'listingsFound',listings_found,'productsFound',products_found,'startedAt',started_at,'finishedAt',finished_at,'notes',notes) from lr)
);
$function$;
