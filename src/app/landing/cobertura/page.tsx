      ...
      <section className={marketing.subHero}>
        <div className={marketing.subHeroInner}>
          <div className={marketing.heroCopy}>
            ...
            <p>Publicamos la cobertura operativa de supermercados, farmacias y multitiendas para que puedas validar si tus cadenas prioritarias están disponibles antes de crear una cuenta.</p>
