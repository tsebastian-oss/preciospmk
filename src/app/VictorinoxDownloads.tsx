...
export default function VictorinoxDownloads() {
  ...
  return <section className={styles.downloads}>
    <div className={styles.downloadHero}>
      <div><span>EXPORTACIÓN DE DATOS</span><h2>Descarga las bases de Victorinox</h2><p>Mercado vigente, matriz competitiva y capturas de mercado acumuladas en Supabase, listas para Excel.</p></div>
    ...
    <div className={styles.downloadGrid}>
      ...
      <article><span>CSV · HISTÓRICO</span><h3>Capturas de mercado</h3><p>Serie acumulada desde la lectura actual; suma puntos con nuevas lecturas y scrapes.</p>{action("history", "Descargar ↓")}</article>
    </div>
  </section>;
}
